 ...
 *       la #09, **las hojas de estilo enlazadas, en orden**.
 *
 ...
 * puso en juego.
 *
 * ── Y `hojas`, que entró en la #09 ───────────────────────────────────────
 * La orden #09 le agregó un `<link rel="stylesheet">` al `<head>` de las cuatro
 ...
 *
 * Así que la lista se amplía, y se declara: ahora incluye **las hojas
 * enlazadas, en orden**. Que sean dos y en este orden es el contrato entero de
 * `@codice/ui` visto desde el navegador; que estén acá significa que volver a
 * fusionarlas —o darlas vuelta— reescribe cuatro capturas y aparece en el diff
 * del PR en vez de pasar callado.
 *
